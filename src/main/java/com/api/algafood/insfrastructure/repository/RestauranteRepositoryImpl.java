...
import com.api.algafood.domain.repository.restaurante.RestauranteRepositoryQueries;
...
//        /*CRIANDO CONSULTAS DINAMICAMENTE*/
...
//        return query.getResultList();
        ...
        criteriaQuery.where(predicates.toArray(new Predicate[0]));// precisa transformar a lista em array
